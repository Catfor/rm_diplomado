...
$id_paciente=$_GET['id_paciente'];
 ?>
la atencion del paciente es <?php echo $id_paciente ?>
  <form id="frm" name="frm" action="m.php" method="POST">
...
<select name="sucursal" class="form-control" required>
  ...
  <select>
    ...
    <center> <br> <br> <br>
    <div class="row">
        <div class="col-xs-2">Fecha de la última regla::
       ...
       <div class="col-xs-2">
       Fecha de atención en Reina Madre:
      <input type="text" name="apellidos" required>
      </div>
...
<input type="button" id="btn-ingresar" onclick="return valida_form()" value="Ingresar" /><br><br>
