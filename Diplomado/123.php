        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="sistema.php"><img src="img/logo/logo.webp" alt="" /></a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" name="nombre_paciente" class="form-control" placeholder="Nombres del paciente">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" name="apellidos_paciente" class="form-control" placeholder="Apellidos Del Paciente">
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p>Cuenta con algùn Tipo de Seguro:</p>
                                      ...
                                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <label><input type="checkbox" name="personality"> IMSS    </label>
                                        <label><input type="checkbox" name="personality">ISSTE  </label>
                                        <label><input type="checkbox" name="personality"> Seguro Popular  </label>
                                        <label><input type="checkbox" name="personality">SGMM  </label>
                                      </div>
